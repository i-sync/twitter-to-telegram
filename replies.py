...
t = twitter.Api(
    consumer_key=configs.twitter.apikey,
...
if __name__ == "__main__":
    ...
    json_data = '{"user":{"screen_name": "jamella_hoshino"},"id": 1559217532397096961}'
    # for tweet in get_tweets(tweets_file):
    for tweet in [twitter.Status.NewFromJsonDict(json.loads(json_data))]:
        print(tweet)
